...
function animate() {
  ...
  tl.addLabel("frame1", 0)
    .staggerFrom(".copy1 span", 1, { y: 120, autoAlpha: 0, ease: "Power2.easeInOut" }, 0.05, "frame1")
    .staggerFrom(".copy2 span", 1, { y: 120, autoAlpha: 0, ease: "Power2.easeInOut" }, 0.05, "frame1+=1.3")
