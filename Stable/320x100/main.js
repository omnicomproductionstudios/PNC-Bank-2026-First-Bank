...
function animate() {
  ...
  tl.addLabel("frame1", 0)
    .to(".logo", 0.7, {x:-74, ease: "Power2.easeInOut" }, "frame1+=0.7")
    ...
    .to([".logo",".tagBg", ".tag"], 0.7,{autoAlpha:0, ease: "Power2.easeInOut"}, "frame1+=2.5") // empty tween to create a delay before frame 2

  tl.addLabel("frame2", "frame1+=3")
    .staggerFrom(".copy1 span", 1, { y: 50, autoAlpha: 0, ease: "Power2.easeInOut" }, 0.05, "frame2")
    .staggerFrom(".copy2 span", 1, { y: 50, autoAlpha: 0, ease: "Power2.easeInOut" }, 0.05, "frame2+=1.3")
    .from("#cta", 1, { y: 40, autoAlpha: 0, ease: "Power2.easeInOut" }, "frame2+=2.6")
}
